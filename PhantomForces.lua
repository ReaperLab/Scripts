...
local win = OrionLib:MakeWindow({Name = "PhantomForces".. addString, HidePremium = not Request("mode"), SaveConfig = true, ConfigFolder = "PhantomForces", IntroText="PhantomForces".. addString})
